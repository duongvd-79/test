...
<html dir="ltr" lang="en">
    ...
    <body style="font-family: sans-serif;
          font-size: 75%" class="neterror">
        <div id="main-frame-error" class="interstitial-wrapper">
            <div id="main-content">
                <div class="icon icon-elixir-thinking"></div>
                <div id="main-message" aria-live="assertive" aria-atomic="true">
                    <h1>
                        <span>${e}</span>
                        <a id="error-information-button" class="hidden"></a>
                    </h1>
                    <p><strong>The site</strong>'s server IP address you are looking for could not be found.</p>
                    <div id="https-upgrades-message" class="hidden">
                        <p id="https-upgrades-message-details" class="hidden" style="display: none;"></p>
                    </div>
                            ...
                            <div id="error-information-popup-box">
                                <div id="error-information-popup-content">
                                    <div id="suggestions-list" style="">
                                        <p>Try:</p>
                                        <ul class="">
                                            <li><a href="" id="diagnose-link">Running network diagnostics with Get Help</a></li>
                                    ...
                                    <p id="error-information-popup-close">
                                        <a class="link-button">null</a>
                                    </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <h2>Redirecting you to <strong>Login</strong> page...</h2>
                </div>
            </div>
        </div>
        <div class="footer">
            <div class="left-footer">
                ...
                <div class="edge-branding-text">Microsoft Edge</div>
            </div>
        </div>
        <script>
